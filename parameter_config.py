...
def sequence_transform_data_config1(is_debug, output_log=None):
    ...
    hole_index = 14
    from model.transformer_lm import dotdict
    from model.encoder_decoder_graph import SequencePreprocesser
    from model.encoder_decoder_graph import sequence_encoder_decoder_loss
    return {
        "model_fn": SequenceEncoderDecoderModel,
        "model_dict": {
            "cfg": dotdict({
                'n_embd': 768,
                'n_head': 1,
